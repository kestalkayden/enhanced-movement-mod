 ...
 * in-game screen threw on open (from ModMenu on Fabric, from the mods-list Config button on
 * NeoForge). Storage is now plain Gson at {@code config/enhancedmovement.json} — the SAME path and
